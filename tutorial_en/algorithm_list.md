    ...
    <ul class="fullclick">
        ...
        <li>
            <a href="../thanosql_search/search_text_by_text/">
                ...
                <p>
                    <br>Use the ThanoSQL's text-to-text search model to search for the desired docum../ent.</br>
                </p>
            </a>
        </li>
        <li>
    ...
    <ul class="fullclick">
        ...
        <li>
            <a href="../thanosql_ml/question_answering/visual_question_answering/">
                ...
                <p>
                    <br>
                        Use the ThanoSQL's Visual Question Answering model to find an appropriate answer to a question wh../en an image and a question about the image are giv../en.
                    </br>
                </p>
            </a>
        </li>
